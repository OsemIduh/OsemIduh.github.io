...
<body>
 ...
 // $answer17 = $_POST['Question17'];
  ...
  if (isset($_POST["Question1"]) == "CorrectAnswer1"){
    $score++;
  }
  if (isset($_POST["Question2"]) == "CorrectAnswer2"){
    $score++;
  }
  if (isset($_POST["Question3"]) == "CorrectAnswer3"){
    $score++;
  }
  if (isset($_POST["Question4"]) == "CorrectAnswer4"){
    $score++;
  }
  if (isset($_POST["Question5"]) == "CorrectAnswer5"){
    $score++;
  }
  if (isset($_POST["Question6"]) == "CorrectAnswer6"){
    $score++;
  }
  if (isset($_POST["Question7"]) == "CorrectAnswer7"){
    $score++;
  }
  if (isset($_POST["Question8"]) == "CorrectAnswer8"){
    $score++;
  }
  if (isset($_POST["Question9"]) == "CorrectAnswer9"){
    $score++;
  }
  if (isset($_POST["Question10"]) == "CorrectAnswer10"){
    $score++;
  }
  if (isset($_POST["Question11"]) == "CorrectAnswer11"){
    $score++;
  }
  if (isset($_POST["Question12"]) == "CorrectAnswer12"){
    $score++;
  }
  if (isset($_POST["Question13"]) == "CorrectAnswer13"){
    $score++;
  }
  if (isset($_POST["Question14"]) == "CorrectAnswer14"){
    $score++;
  }
  if (isset($_POST["Question15"]) == "CorrectAnswer15"){
    $score++;
  }
  if (isset($_POST["Question16"]) == "CorrectAnswer16"){
    $score++;
  }
  if (isset($_POST["Question17"]) == "CorrectAnswer17"){
    $score++;
  }
  if (isset($_POST["Question18"]) == "CorrectAnswer18"){
    $score++;
  }
  if (isset($_POST["Question19"]) == "CorrectAnswer19"){
    $score++;
  }
  if (isset($_POST["Question20"]) == "CorrectAnswer20"){
    $score++;
  }
 ...
 // }
  ...
  //if (isset($answer2) == "CorrectAnswer2"){
   // $score++;
 // }
